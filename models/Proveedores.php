...
class Proveedores extends ActiveRecord
{
    ...
    protected static $columnasDB = ['cod_tercero', 'tipo', 'nit', 'dv', 'tip_nit', 'razon_social', 'nombre1', 'nombre2', 'apellido1', 'apellido2', 'direccion', 'telefono', 'plazo', 'regimen', 'cod_ciudad', 'e_mail1', 'fecha_ingreso'];
