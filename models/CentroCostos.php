...
class CentroCostos extends ActiveRecord
{
    protected static $tabla = 'c_centro_costos';
    protected static $columnasDB = ['ccc_codigo', 'ccc_nombre'];
    ...
    {
        $this->ccc_codigo = $args['ccc_codigo'] ?? '';
        $this->ccc_nombre = $args['ccc_nombre'] ?? '';
