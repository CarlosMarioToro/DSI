...
{
    protected static $tabla = 'c_paises';
    protected static $columnasDB = ['codpais', 'despais', 'country_code'];
    ...
    {
        $this->ciu_codigo = $args['codpais'] ?? '';
        $this->ciu_nombre = $args['des_transportador'] ?? '';
        $this->ciu_cod_dian = $args['country_code'] ?? '';
    }
